...
do_sim = function(pos, cond, iters) {
  ...
  fffname = paste("/home/s421506/ideal-restricted/results/res_idealres_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], ".dat", sep = "")
  print(fffname)

  write.table(results.cond, file = paste("/home/s421506/ideal-restricted/results/res_idealres_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], ".dat", sep = ""), row.names=F, col.names=T)
...
writeLines(capture.output(sessionInfo()), "/home/s421506/ideal-restricted/results/ideal-restricted-sessioninfo.txt")
