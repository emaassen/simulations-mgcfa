...
do_sim = function(pos, cond, iters) {
  ...
  fffname = paste("../results/res_inter_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], "_", results.cond[1,"nus"[3]], ".dat", sep = "")
  print(fffname)
  
  write.table(results.cond, file = paste("../results/res_inter_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], "_", results.cond[1,"nu"], ".dat", sep = ""), row.names=F, col.names=T)
  write.table(results.cond.str, file = paste("..results/res_inter_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], "_", results.cond[1,"nu"], "_str.dat", sep = ""), row.names=F, col.names=T)
...
writeLines(capture.output(sessionInfo()), "../results/intercepts-sessioninfo.txt")
